...
> 更新日期：2026-07-30  
> 项目目录：`/home/gtk/isaac_ocs_project`  
...
| `assets/scenes/615scene_20260723/` | 场景引用层和模型资产，不可随意移动 |
| `projects/ros2_ws/src/` | ROS 2、OCS2、控制器和机器人资源源码 |
| `projects/Trajectory/SIM1/` | 示教、夹爪、底盘、相机、回放和数据工具 |
...
- 每次重新打开场景后，由 `scripts/rebuild_six_camera_render_products_20260730.py` 重建。
...
```bash
projects/Trajectory/SIM1/game_control.sh check
projects/Trajectory/SIM1/game_control.sh reset
projects/Trajectory/SIM1/game_control.sh teach
projects/Trajectory/SIM1/game_control.sh teach-with-cameras
projects/Trajectory/SIM1/game_control.sh demo
projects/Trajectory/SIM1/game_control.sh camera-grid
projects/Trajectory/SIM1/game_control.sh base-record
projects/Trajectory/SIM1/game_control.sh base-path-demo
projects/Trajectory/SIM1/game_control.sh direct-demo
```
...
| `scripts/docker_build_ros2_ws_20260730.sh` | 支持通过环境变量指定隔离的 build/install/log 目录 |
...
- `docs/PROJECT_HANDOVER_20260730_zh.md`
- `docs/startup_guide_20260723_zh.md`
- `projects/Trajectory/SIM1/PROJECT_OVERVIEW.md`
- `projects/Trajectory/SIM1/GAME_GUIDE.md`
- `projects/Trajectory/SIM1/TRACE_DATA_FORMAT.md`
