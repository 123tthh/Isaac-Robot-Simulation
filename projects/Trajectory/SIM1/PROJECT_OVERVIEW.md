...
本文是规范化工程中 `projects/Trajectory/SIM1` 的模块总览。项目级启动方法以
`/home/gtk/isaac_ocs_project/docs/startup_guide_20260723_zh.md` 为准。
...
- [CLAUDE_HANDOFF_GRIPPER_PROJECT.md](CLAUDE_HANDOFF_GRIPPER_PROJECT.md)：历史接手说明，包含夹爪控制和 OCS2 链路背景。
