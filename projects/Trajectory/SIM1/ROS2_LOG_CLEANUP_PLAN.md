...
SIM1 工程总纲见 [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md)。本文件只说明 `~/ros2_log` 的辅助整理计划，不是示教/回放入口。

生成时间：2026-05-28 14:47-14:50  
目标目录：`/home/gtk/ros2_log`  
当前工程目录：`/home/gtk/Trajectory/SIM1`
...
注意：这是 `~/ros2_log` 的历史日志/脚本整理计划，不是当前 SIM1 新采集数据规范。SIM1 示教数据以 `~/Trajectory/SIM1/trace_data/raw/`、`trace_data/cleaned/`、`trace_data/lerobot_v30/`、`trace_data/lerobot_v21/` 为准；完整格式见 `TRACE_DATA_FORMAT.md`。
