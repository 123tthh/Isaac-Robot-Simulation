...
Scene/control references in this workspace:
  ...
  - /home/gtk/Trajectory/converted_lerobot/local/place_tray_middle/export_rm_dual_episode.py
"""
...
DEFAULT_TRAJECTORY_DIR = Path(os.environ.get("TRAJECTORY_DIR", "/workspace/projects/Trajectory"))
DEFAULT_EPISODE = (
