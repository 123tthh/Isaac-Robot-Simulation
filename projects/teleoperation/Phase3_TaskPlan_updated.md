...
> 搭配 `~/ros2_ws/CLAUDE.md`、`~/teleoperation/sim1/PROJECT_OVERVIEW.md`、`TRACE_DATA_FORMAT.md`、`GAME_GUIDE.md`、`ALL_Graph.md`、`Gripper_Control_Graph.md`、`scene_structure.md` 使用。
...
```text
~/teleoperation/sim1/tools/trajectory_augmenter.py
~/teleoperation/sim1/tools/isaac_batch_tester.py
~/teleoperation/sim1/tools/success_judge.py
~/teleoperation/sim1/tools/export_generated_lerobot.py
```
