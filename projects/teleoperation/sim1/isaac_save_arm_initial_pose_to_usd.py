...
exec(open("projects/teleoperation/sim1/isaac_save_arm_initial_pose_to_usd.py").read())
...
- https://docs.isaacsim.omniverse.nvidia.com/5.1.0/python_scripting/robots_simulation.md
- https://docs.isaacsim.omniverse.nvidia.com/5.1.0/robot_setup/asset_validation.md
- projects/teleoperation/sim1/capture_arm_initial_pose.py
"""
...
SIM1_DIR = Path(os.environ.get("SIM1_DIR") or (
    str(Path(globals()["__file__"]).resolve().parent)
    if "__file__" in globals()
    else str(Path(os.environ.get("ISAAC_OCS_PROJECT_ROOT", os.getcwd())) / "projects/teleoperation/sim1")
))
...
# SAVE_AS_PATH = str(SIM1_DIR / "usd/SIM1_with_arm_initial_pose.usd")
SAVE_AS_PATH = ""
