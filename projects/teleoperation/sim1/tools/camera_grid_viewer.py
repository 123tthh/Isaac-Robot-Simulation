...
Local documentation referenced:
  ...
  - https://docs.ros.org/en/rolling/p/sensor_msgs/msg/Image.md
  - projects/teleoperation/sim1/tools/camera_recorder.py
...
def parse_args(argv: Sequence[str]) -> tuple[argparse.Namespace, Sequence[str]]:
    ...
    parser.add_argument(
        ...
        default="reliable",
        help="ROS2 QoS reliability (reliable matches this project's CameraHelpers).",
    )
    parser.add_argument(
        "--window-title",
