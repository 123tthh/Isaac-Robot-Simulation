...
Local documentation referenced:
  ...
  - https://docs.ros.org/en/rolling/p/rclpy/rclpy.executors.md
  - https://docs.ros.org/en/rolling/p/examples_rclpy_minimal_subscriber/examples_rclpy_minimal_subscriber.subscriber_member_function.md
...
def parse_args():
    ...
    parser.add_argument(
        "--output-root",
        type=str,
        default=str(Path(__file__).resolve().parents[1] / "trace_data/raw"),
    ...
    parser.add_argument(
        ...
        default="reliable",
        help="ROS2 QoS reliability (project CameraHelpers publish reliable; use best_effort for other sensor publishers).",
    )
