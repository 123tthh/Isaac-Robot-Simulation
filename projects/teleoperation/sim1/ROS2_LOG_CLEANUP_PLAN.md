...
注意：这是 `~/ros2_log` 的历史日志/脚本整理计划，不是当前 SIM1 新采集数据规范。SIM1 示教数据以 `~/teleoperation/sim1/trace_data/raw/`、`trace_data/cleaned/`、`trace_data/lerobot_v30/`、`trace_data/lerobot_v21/` 为准；完整格式见 `TRACE_DATA_FORMAT.md`。
