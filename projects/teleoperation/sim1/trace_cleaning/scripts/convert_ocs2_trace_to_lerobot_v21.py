...
External schema references:
  ...
  - https://github.com/huggingface/lerobot/blob/v0.3.3/src/lerobot/datasets/lerobot_dataset.py
...
def main() -> int:
    ...
    copy_selected_videos(camera_dir, args.output, camera_rows, camera_indices, v30=False, fps=args.fps)
