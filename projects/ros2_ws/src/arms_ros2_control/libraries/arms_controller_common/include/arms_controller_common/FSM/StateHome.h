...
namespace arms_controller_common
{
    ...
    public:
        ...
        /**
         * @brief Set natural frequency for critical damping filter (used when interpolation type is CRITICAL_DAMPING).
         * @param omega Natural frequency in rad/s.
         */
        void setFilterOmega(double omega);
    ...
    private:
        ...
        double filter_omega_{10.0};       // Natural frequency for critical damping filter
        std::vector<double> current_vel_; // Current velocity for filter
