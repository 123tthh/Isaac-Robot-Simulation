...
namespace ocs2::mobile_manipulator
{
    ...
    controller_interface::CallbackReturn Ocs2ArmController::on_init()
    {
        try
        {
            ...
            double home_filter_omega = auto_declare<double>("home_filter_omega", 10.0);
            state_list_.home->setInterpolationType(home_interpolation_type);
            state_list_.home->setTanhScale(home_tanh_scale);
            state_list_.home->setFilterOmega(home_filter_omega);
            ...
            double movej_filter_omega = auto_declare<double>("movej_filter_omega", 10.0);
            ...
            state_list_.movej->setFilterOmega(movej_filter_omega);
