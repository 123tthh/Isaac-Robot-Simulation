...
namespace ocs2::mobile_manipulator
{
    ...
    public:
            ...
            : node_(node), ctrl_interfaces_(ctrl_interfaces)
        {
            ...
            // MPC output filter
            mpc_filter_enabled_ = auto_declare("mpc_filter_enabled", false);
            mpc_filter_omega_ = auto_declare("mpc_filter_omega", 20.0);
    ...
    private:
        ...
        // MPC output filter
        bool mpc_filter_enabled_{false};
        double mpc_filter_omega_{20.0};
        vector_t filter_vel_;
        vector_t last_filter_pos_;
