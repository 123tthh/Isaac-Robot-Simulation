...
namespace ocs2::mobile_manipulator
{
    ...
    class PoseBasedReferenceManager : public ReferenceManagerDecorator
    {
         ...
         * @param time_from_start 插值持续时间。如果小于0，则使用默认的 moveL_duration_
         */
        ...
        void leftPoseStampedPoseCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
        void rightPoseStampedPoseCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
